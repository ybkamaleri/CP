...
## CP ICD-10 koder
navnICD <- c("G80.2 Høyre hemiplegi", "G80.2 Venstre hemiplegi", "G80.1 Diplegi",
             "G80.0 Kvadriplegi", "G80.3 Choreoathetose", "G80.3 Dystoni", "G80.4 Ataxi",
             "G80.9 Uspesifisert CP", "G80.8 Annen spesifisert infantil CP")
tabICD <- data.table(CPDIAG = 1:9, diag = navnICD)
...
legLand <- paste0("(L) Landet forøvrig (N=", sumCP, ")")
